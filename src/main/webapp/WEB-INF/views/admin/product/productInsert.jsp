...
<div class="wrapper">
 ...
 <form action="productInsert" method="post" id="joinForm" enctype="multipart/form-data">
  <div class="form-row">
    <div class="col-md-6">
	    <label for="pdt_num">상품코드</label>
	    <input type="text" class="form-control" id="pdt_num" name="pdt_num">
	</div>
	<div class="col-md-6">
  ...
  <div class="form-row">
	...
	<div class="col-md-4">
	    ...
	    <input type="text" class="form-control" id="pdt_publisher" name="pdt_publisher">
    </div>
  </div>
   <!-- 상품설명 : CKeditor -->
   <div class="form-row">
    <div class="col-md-12">
      ...
      <textarea id="pdt_content" name="pdt_content" rows="10" cols="80"></textarea>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4">
